...
x(0)=1 \qquad x(1)=3
\]
pomijajac przekształcenia ostatecznie otrzymano analitycznie wyznaczoną optymalną trajektorie:
\[
x^*=t^3+t+1
\]
...
Analitycznie wyznaczona optymalna trajektoria wynosiła:
\[
x^*=t^3+t+1
\]
...
Widać że, przebiegi trajektori osiagniętej metodami numerycznymi i trajektori wyprowadzonej analitycznie pokrywaja sie co dowodzi skuteczności i wiarygodności rezultatów osiganych poprzez bibliotekę GEKKO
