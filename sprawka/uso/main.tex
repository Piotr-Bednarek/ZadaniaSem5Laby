...
Na zajeciach numer 5 przedstawiono metody optymalizacji matematycznej, rozpatrywano dany problem:
\[
...
x(0)=1 \qquad x(1)=3
\]
pomijajac przekształcenia ostatecznie otrzymano analitycznie optymalną trajektorie:
\[
x^*=t^3+t+1
\]
...
Po wyznaczeniu wuktora wartosci dla trajektori wyznaczonej analitycznie, i naniesieniu jej na jeden wykres wspólnie z trajektoria obliczoną przez GEKKO można stwierdzić że trajektorie te pokrywaja sie z nieznacznym błedem. Do wyznaczenia rzedu tego błedu może posłużyc wartość całkowego wskacnika jakości:
\[
J_{GEKKO}= 32.729852
\] 
\[
...
\end{center}
\[
J_{analitycznie}=\int_{0}^{1} 24(t^3+t+1)t + 2(3t^2+1)^2 -4t dt = \frac{466}{15} \approx 31.067
\]

Co daje nam błąd na poziomie:
\[
\frac{32.729852-31.067}{31.067}\cdot 100\%=5.53\%
\]
