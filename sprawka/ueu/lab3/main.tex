...
Napiecie $U_2$ mozna okreslic jako:
\[
...
sygnał wynikowy bedzie przeciwna w fazie suma sygnału $U_1$ i dwukrotnosci $U_2$
...
Obecność plusa badz minusa zalezy faz sygnałów wchodzacych do sumatora.Jeśli śą zgodne w fazie 
pojawia sie plus, jeśli przeciwne to minus.Wartosci obliczone pokrywaja sie z wartościami pomiarów 
...
wiec sygnał na wyjsciu wzmacniacza bedzie dwukrotnym 
...
Obecność plusa badź minusa we wzmocnieniu zależy od tego czy sygnały są 
zgodne czy przeciwne w fazie. sygnały zgodne w fazie to minus, przeciewne plus.
