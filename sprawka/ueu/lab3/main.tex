...
\section{Wnioski}
 Przeprowadziliśmy pomiary układów i porównanaliśmy
 je z przewidywaniami teoretycznymi. Sumator inwerujący zachowywał się zgodnie z teorią 
,napięcie wyjściowe jest odwrotnością fazową ważonej sumy sygnałów wejściowych, wartości obliczone zgadzają się z pomiarami. Wzmacniacz różnicowy wykazał
   ...
   tłumieniu sygnałów wspólnych, ograniczenia wynikają z niedoskonałości elementów i wzmacniacza. Główne źródła
    niepewności to tolerancje rezystorów, offset wejściowy, ograniczenia pasma, szumy oraz dokładność przyrządów 
    pomiarowych; dla lepszej zgodności z teorią zaleca się stosowanie precyzyjnych rezystorów, kompensację offsetu 
    oraz uwzględnienie parametrów rzeczywistych wzmacniaczy przy projektowaniu układów.
