...
\begin{document}
	...
	Zgodnie z zalozeniami teoretycznymi charakterystyki sterowanie są wzglednie równoległe. Rozbiezność na poziomie:
	\[
	\frac{5,16-5,05}{5,16}\cdot 100\% \approx 2,9\% 
	\]

	jest akceptowalna ze wzgledu na błedy toru pomiarowego.
